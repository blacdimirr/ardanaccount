                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::text('supplier_type', $bill->supplier_type, ['class' => 'form-control', 'list' => 'supplier-types-list', 'placeholder' => __('Ej. Profesional independiente, bienes gravados, etc.')]) }}
