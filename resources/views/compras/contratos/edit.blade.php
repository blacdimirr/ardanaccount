...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    {!! Form::model($contrato, ['route' => ['compras.contratos.update', $contrato->id], 'method' => 'put']) !!}
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <x-required></x-required>
                                {{ Form::number('monto_contrato', null, ['class' => 'form-control', 'required' => true, 'step' => '0.01']) }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <x-required></x-required>
                                {{ Form::date('fecha_inicio', $contrato->fecha_inicio, ['class' => 'form-control', 'required' => true]) }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {{ Form::label('fecha_fin', __('End Date'), ['class' => 'form-label']) }}
                                {{ Form::date('fecha_fin', $contrato->fecha_fin, ['class' => 'form-control']) }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <x-required></x-required>
                                {{ Form::select('estado', \App\Models\ContratoCompra::estados(), $contrato->estado, ['class' => 'form-control select', 'required' => true]) }}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="partida_presupuestaria_id" class="form-control select">
                                    ...
                                    @foreach ($categorias as $categoria)
                                        <option value="{{ $categoria->id }}" {{ $contrato->partida_presupuestaria_id == $categoria->id ? 'selected' : '' }}>
                                            {{ $categoria->name }}
                                        </option>
                                    @endforeach
                                </select>
