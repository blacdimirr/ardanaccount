...
<div class="row">
    ...
    <div class="form-group  col-md-6">
        ...
        {{ Form::text('ncf_series', $expense->ncf_series, ['class' => 'form-control','placeholder'=>__('Series as provided by vendor')]) }}
        @error('ncf_series')
    ...
    <div class="form-group  col-md-6">
        ...
        <div class="form-icon-user">
            ...
            {{ Form::text('ncf_number', $expense->ncf_number, ['class' => 'form-control','placeholder'=>__('Enter NCF number from vendor invoice')]) }}
        </div>
        @error('ncf_number')
