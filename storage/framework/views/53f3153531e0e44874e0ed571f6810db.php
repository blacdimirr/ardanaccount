                        ...
                        <div class="col-lg-3 col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="mb-3 "><a href="<?php echo e(route('customer.index')); ?>" class="text-primary" ><?php echo e(__('Customers')); ?></a></h6>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted text-sm mt-4 mb-2"><?php echo e(__('Total')); ?></p>
                                    <h6 class="mb-3 "><a href="<?php echo e(route('vender.index')); ?>" class="text-info" ><?php echo e(__('Vendors')); ?></a></h6>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted text-sm mt-4 mb-2"><?php echo e(__('Total')); ?></p>
                                    <h6 class="mb-3 "><a href="<?php echo e(route('invoice.index')); ?>" class="text-warning" ><?php echo e(__('Invoices')); ?></a></h6>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted text-sm mt-4 mb-2"><?php echo e(__('Total')); ?></p>
                                    <h6 class="mb-3 "><a href="<?php echo e(route('bill.index')); ?>" class="text-danger" ><?php echo e(__('Bills')); ?></a></h6>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-muted text-sm mb-1"><?php echo e(__('Income Today')); ?></p>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-muted text-sm mb-1"><?php echo e(__('Expense Today')); ?></p>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-muted text-sm mb-1"><?php echo e(__('Income This Month')); ?></p>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-muted text-sm mb-1"><?php echo e(__('Expense This Month')); ?></p>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($invoice->status == 0): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badges badge bg-secondary"><?php echo e(__(\App\Models\Status::getNameById($invoice->status))); ?></span>
                                                    <?php elseif($invoice->status == 1): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badges badge bg-warning"><?php echo e(__(\App\Models\Status::getNameById($invoice->status))); ?></span>
                                                    <?php elseif($invoice->status == 2): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badges badge bg-danger"><?php echo e(__(\App\Models\Status::getNameById($invoice->status))); ?></span>
                                                    <?php elseif($invoice->status == 3): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badges badge bg-info"><?php echo e(__(\App\Models\Status::getNameById($invoice->status))); ?></span>
                                                    <?php elseif($invoice->status == 4): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badges badge bg-success"><?php echo e(__(\App\Models\Status::getNameById($invoice->status))); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($bill->status == 0): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badges badge bg-secondary"><?php echo e(__(\App\Models\Status::getNameById($bill->status))); ?></span>
                                                    <?php elseif($bill->status == 1): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badges badge bg-warning"><?php echo e(__(\App\Models\Status::getNameById($bill->status))); ?></span>
                                                    <?php elseif($bill->status == 2): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badges badge bg-danger"><?php echo e(__(\App\Models\Status::getNameById($bill->status))); ?></span>
                                                    <?php elseif($bill->status == 3): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badges badge bg-info"><?php echo e(__(\App\Models\Status::getNameById($bill->status))); ?></span>
                                                    <?php elseif($bill->status == 4): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badges badge bg-success"><?php echo e(__(\App\Models\Status::getNameById($bill->status))); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\accountgo\resources\views/dashboard/index.blade.php ENDPATH**/ ?>