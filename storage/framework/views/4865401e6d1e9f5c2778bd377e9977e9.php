...
<?php endif; ?>
                                <?php echo e(Form::select('vender_id', $venders, $vendorId, ['class' => 'form-control select2', 'id' => 'vender', 'data-url' => route('bill.vender'), 'required' => 'required'])); ?>

                                <div class="text-xs mt-1">
                                    <?php echo e(__('Create vendor here.')); ?> <a
                                        href="<?php echo e(route('vender.index')); ?>"><b><?php echo e(__('Create vendor')); ?></b></a>
                                </div>
                            </div>
...
<?php endif; ?>
                                        <div class="form-icon-user">
                                            <?php echo e(Form::date('due_date', date('Y-m-d', strtotime('+1 months')), ['class' => 'form-control', 'required' => 'required'])); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-icon-user">
                                            <label> <?php echo e(__('Has retention')); ?></label>
                                            <?php echo e(Form::checkbox('has_retention', 1, false)); ?>
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    <td width="25%" class="form-group pt-0 flex-nowrap">
                                        <?php echo e(Form::select('item', $product_services, '', ['class' => 'form-control item select2', 'data-url' => route('bill.product'), 'required' => 'required'])); ?>
                                    ...
                                    <td>
                                        <div class="form-group price-input input-group search-form flex-nowrap">
                                            <?php echo e(Form::number('price', '', ['min' => '0.00', 'step' => '.01', 'class' => 'form-control price', 'required' => 'required', 'placeholder' => __('Price'), 'required' => 'required'])); ?>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="text-danger">
                                        <strong><?php echo e(__('Retención 5% (sobre neto)')); ?>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td class="text-danger">
                                        <strong><?php echo e(__('Retención 30% (sobre ITBIS)')); ?>
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td class="blue-text">
                                        <strong><?php echo e(__('Total con impuestos')); ?>
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td class="blue-text">
                                        <strong><?php echo e(__('Pago final al proveedor')); ?>
