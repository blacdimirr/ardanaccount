...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $arrPermissions = [
            ...
            [
                'name' => 'nomina_ir3_generate',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'nomina_ir4_generate',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            ...
            [
                'name' => 'tesoreria_extractos_import',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            ...
            [
                'name' => 'reportes_financieros_publicos_view',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            ...
            [
                'name' => 'nomina_conceptos_manage',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'nomina_periodos_manage',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'nomina_config_ss_manage',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            ...
            [
                'name' => 'config_clasificadores_manage',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            ...
            [
                'name' => 'compras_requisicion_create',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'name' => 'compras_proceso_manage',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'name' => 'compras_adjudicar',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'name' => 'compras_contratos_manage',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            ...
            [
                'name' => 'reportes_dgii_608_generate',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
        ...
        $companyPermissions = [
            ...
            'compras_pac_manage',
            'compras_requisicion_create',
            'compras_proceso_manage',
            'compras_adjudicar',
            'compras_contratos_manage',
