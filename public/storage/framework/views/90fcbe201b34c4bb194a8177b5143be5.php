...
<?php $__env->startSection('action-btn'); ?>
    <div class="d-flex">
        <a href="#" data-size="md" data-bs-toggle="tooltip" title="<?php echo e(__('Import')); ?>"
            data-url="<?php echo e(route('customer.file.import')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Import customer CSV file')); ?>" class="btn btn-sm btn-primary me-2">
            <i class="ti ti-file-import"></i>
        </a>
        <a href="<?php echo e(route('customer.export')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Export')); ?>"
            class="btn btn-sm btn-primary me-2">
            <i class="ti ti-file-export"></i>
        </a>

        <a href="#" data-size="xl" data-url="<?php echo e(route('customer.create')); ?>" data-ajax-popup="true"
            data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create Customer')); ?>"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="cust_tr" id="cust_detail"
                                        data-url="<?php echo e(route('customer.show', $customer['id'])); ?>"
                                        ...
                                        <td class="Action">
                                            <span>
                                                ...
                                                <?php else: ?>
                                                    <?php if($customer->is_enable_login == 0 && $customer->password == null): ?>
                                                        <div class="action-btn me-2">
                                                            <a href="#" class="mx-3 btn btn-sm  align-items-center login_enable bg-primary"
                                                                data-url="<?php echo e(route('customer.reset', \Crypt::encrypt($customer['id']))); ?>"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit customer')): ?>
                                                        <div class="action-btn me-2">
                                                            <a href="#" class="mx-3 btn btn-sm  align-items-center bg-info"
                                                                data-url="<?php echo e(route('customer.edit', $customer['id'])); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/resources/views/customer/index.blade.php ENDPATH**/ ?>