                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <?php if(in_array('trial balance '.$module,(array) $permissions)): ?>
                                            ...
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if(in_array('contract'.$module,(array) $permissions)): ?>
                                            <?php if($key = array_search('contract'.$module,$permissions)): ?>
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    <?php echo e(Form::checkbox('permissions[]',$key,$role->permission,false, ['class'=>'form-check-input isscheck isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])); ?>

                                                    <?php echo e(Form::label('permission'.$key,'contract',['class'=>'form-check-label'])); ?><br>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if(in_array('convert invoice '.$module,(array) $permissions)): ?>
                                            <?php if($key = array_search('convert invoice '.$module,$permissions)): ?>
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input isscheck isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])); ?>

                                                    <?php echo e(Form::label('permission'.$key,'Convert To Invoice',['class'=>'form-check-label'])); ?><br>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if(in_array('convert retainer '.$module,(array) $permissions)): ?>
                                            <?php if($key = array_search('convert retainer '.$module,$permissions)): ?>
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input isscheck isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])); ?>

                                                    <?php echo e(Form::label('permission'.$key,'Convert To Retainer',['class'=>'form-check-label'])); ?><br>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </div>
...
<?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/resources/views/role/edit.blade.php ENDPATH**/ ?>