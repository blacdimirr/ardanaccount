...
<?php $__env->startSection('action-btn'); ?>
    <div class="d-flex">
        ...
        <a href="<?php echo e(route('payment.export',$date)); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Export')); ?>" class="btn btn-sm btn-primary me-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center justify-content-end">
                            <div class="col-xl-10">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                      ...
                                      <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            <?php echo e(Form::label('ncf', __('Ncf'),['class'=>'text-type'])); ?>

                                            <?php echo e(Form::select('ncf',$account,isset($_GET['ncf'])?$_GET['ncf']:'', array('class' => 'form-control select' ,'id'=>'choices-multiple'))); ?>
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="d-flex">
                                        <a href="#" class="btn btn-sm btn-primary me-2" onclick="document.getElementById('payment_form').submit(); return false;" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>" data-original-title="<?php echo e(__('Apply')); ?>">
                        ...
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="font-style">
                                    ...
                                    <td><?php echo e(!empty($payment->ncf)?$payment->ncf:'-'); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a  class="mx-3 btn btn-sm align-items-center bg-primary d-inline-flex justify-content-center" href="<?php echo e($paymentpath . '/' . $payment->add_receipt); ?>" download=""
                                        ...
                                        <div class="action-btn me-2">
                                            ...
                                            <a href="<?php echo e($paymentpath . '/' . $payment->add_receipt); ?>"  class="mx-3 btn btn-sm align-items-center bg-secondary d-inline-flex justify-content-center" target="_blank"
                                            data-bs-toggle="tooltip" title="<?php echo e(__('Preview')); ?>"><span class="btn-inner--icon"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/resources/views/payment/index.blade.php ENDPATH**/ ?>