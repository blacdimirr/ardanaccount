                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($account->is_enabled == 1): ?>
                                                    <span
                                                        class="badge bg-success p-2 px-3 "><?php echo e(__('Enabled')); ?></span>
                                                <?php else: ?>
                                                    <span
                                                        class="badge bg-danger p-2 px-3 "><?php echo e(__('Disabled')); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <td class="Action">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\willt\Desktop\Workspace Bladimir\codecanyon-aIPVP9oe-accountgo-accounting-and-billing-tool\main-file\resources\views/chartOfAccount/index.blade.php ENDPATH**/ ?>