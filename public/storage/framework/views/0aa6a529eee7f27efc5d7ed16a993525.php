                                    ...
                                    <div class="form-group mb-0">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="is_screenshots_section_on"
                                                id="is_screenshots_section_on"  <?php echo e(isset($settings['is_screenshots_section_on']) && $settings['is_screenshots_section_on'] == 'on' ? 'checked="checked"' : ''); ?>>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('screenshots_create')); ?>" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" title="<?php echo e(__('Create Screenshot')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/Modules/LandingPage/Resources/views/landingpage/screenshots/index.blade.php ENDPATH**/ ?>