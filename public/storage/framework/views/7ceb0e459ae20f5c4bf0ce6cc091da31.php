                            ...
                            <table class="no-space">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <?php echo e(Utility::dateFormat($settings, $bill->issue_date)); ?></td>
                                    </tr>
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($settings_data['bill_qr_display']) && $settings_data['bill_qr_display'] == 'on'): ?>
                                    <tr>
                                        <td colspan="2">
                                            <div class="view-qrcode">
                                                <?php echo DNS2D::getBarcodeHTML(route('pay.billpay', \Crypt::encrypt($bill->id)), 'QRCODE', 2, 2); ?>
...
<?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/resources/views/bill/templates/template3.blade.php ENDPATH**/ ?>