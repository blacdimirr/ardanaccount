...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card bg-none card-box mt-3">
        <div class="card-body">
            <?php echo e(Form::open(array('url' => 'budget','class'=>'w-100 needs-validation','novalidate'))); ?>
...
<?php endif; ?>
                ...
                <div class="form-group col-md-4">
                    <?php echo e(Form::label('period', __('Budget Period'),['class'=>'form-label'])); ?><?php if (isset($component)) { $__componentOriginaleab1765d328ab3f8835fc5d78676a070 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaleab1765d328ab3f8835fc5d78676a070 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.required','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/resources/views/budget/create.blade.php ENDPATH**/ ?>