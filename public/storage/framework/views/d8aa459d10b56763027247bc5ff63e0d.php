...
<?php endif; ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <?php echo e(Form::text('order_number', null, ['class' => 'form-control', 'placeholder'=>__('Enter Order Number')])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\willt\Downloads\account\account.ardan.com.do\resources\views/bill/edit.blade.php ENDPATH**/ ?>