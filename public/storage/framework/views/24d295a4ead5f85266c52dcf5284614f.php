...
<?php $__env->startSection('action-btn'); ?>
    <div class="d-flex">
        <a href="#" class="btn btn-sm btn-primary me-2" data-url="<?php echo e(route('vender.file.import')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip"
           title="<?php echo e(__('Import')); ?>">
            <i class="ti ti-file-import"></i>
        </a>

        <a href="<?php echo e(route('vender.export')); ?>" class="btn btn-sm btn-primary me-2" data-bs-toggle="tooltip" title="<?php echo e(__('Export')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/resources/views/vender/index.blade.php ENDPATH**/ ?>