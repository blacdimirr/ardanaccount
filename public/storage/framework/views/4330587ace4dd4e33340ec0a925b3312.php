                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto">
                                                            <p class="card-text small text-muted">
                                                                <img class="rounded" src="<?php echo e($logo . '/placeholder.png'); ?>" width="70px" height="60px"
                                                ...
                                                <div class="card mb-3 border shadow-none product_Image">
                                                    <div class="px-2 py-2">
                                                        <div class="row align-items-center">
                                                            <div class="col ml-n2">
                                                                <p class="card-text small text-muted">
                                                                    <img class="rounded" src="<?php echo e($logo . '/' . $home_logo); ?>" width="70px"
                                                                        alt="Image placeholder" data-dz-thumbnail="">
                                                                </p>
                                                            </div>
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn-primary"
                                                                    href="<?php echo e($logo . '/' . $home_logo); ?>" download="" data-bs-toggle="tooltip" 
                                                            ...
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn-danger delete-button"
                                                                    data-image="<?php echo e($home_logo); ?>" data-bs-toggle="tooltip"
                                                                    title="<?php echo e(__('Delete')); ?>">
                                                                    <i class="ti ti-trash text-white"></i>
                                                                </a>
                                                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/Modules/LandingPage/Resources/views/landingpage/homesection.blade.php ENDPATH**/ ?>