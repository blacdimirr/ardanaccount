...
<?php $__env->startSection('action-btn'); ?>
    <div class="d-flex">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create role')): ?>
            <a href="#" data-size="xl" data-url="<?php echo e(route('roles.create')); ?>" data-ajax-popup="true"  data-bs-toggle="tooltip" title="<?php echo e(__('Create Role')); ?>" class="btn btn-sm btn-primary">
                                    ...
                                    <td class="Action">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit role')): ?>
                                            <div class="action-btn me-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center bg-info" data-url="<?php echo e(route('roles.edit',$role->id)); ?>" data-size="xl" data-ajax-popup="true" data-bs-toggle="tooltip" data-original-title="<?php echo e(__('Edit Role')); ?>" title="<?php echo e(__('Edit Role')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/resources/views/role/index.blade.php ENDPATH**/ ?>