...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo e($sup_logo . 'favicon.png'); ?><?php echo e('?'.time()); ?>" type="image" sizes="16x16">
...
<!-- [ features ] start -->
<?php if($settings['is_feature_cards_on'] == 'on'): ?>
                                    ...
                                    <div class="card <?php echo e($key == 0 ? 'bg-primary' : ''); ?>">
                                        <div class="card-body">
                                            <span class="theme-avtar avtar avtar-xl mb-4">
                                                <img src="<?php echo e($logo . '/' . $value['feature_logo']); ?>" alt="" width="70" height="70">
                                            </span>
...
<!-- [ element ] start -->
<?php if($settings['is_feature_section_on'] == 'on'): ?>
...
<!-- [ element ] start -->
<?php if($settings['is_discover_section_on'] == 'on'): ?>
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                <?php if($settings['discover_buy_now_link']): ?>
                    <a href="<?php echo e($settings['discover_buy_now_link']); ?>" class="btn btn-primary">Buy
...
<!-- [ Screenshots ] start -->
<?php if($settings['is_screenshots_section_on'] == 'on'): ?>
...
<!-- [ FAqs ] start -->
<?php if($settings['is_faq_section_on'] == 'on'): ?>
...
<!-- [ testimonial ] start -->
<?php if($settings['is_testimonials_section_on'] == 'on'): ?>
...
<footer class="site-footer bg-gray-100">
    <div class="container">
        <div class="footer-row">
            ...
            <?php if($settings['is_joinus_section_on'] == 'on'): ?>
...
<?php /**PATH C:\Users\willt\Desktop\Workspace Bladimir\codecanyon-aIPVP9oe-accountgo-accounting-and-billing-tool\main-file\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>