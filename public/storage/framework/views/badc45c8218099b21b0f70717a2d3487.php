...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::model($bill, ['route' => ['bill.update', $bill->id], 'method' => 'PUT', 'class' => 'w-100 needs-validation','novalidate'])); ?>
...
<?php endif; ?>
                                <?php echo e(Form::select('vender_id', $venders, null, ['class' => 'form-control select', 'id' => 'vender', 'data-url' => route('bill.vender'), 'required' => 'required'])); ?>
...
<?php endif; ?>
                                        <div class="form-icon-user">
                                            <?php echo e(Form::date('bill_date', null, ['class' => 'form-control', 'required' => 'required'])); ?>
...
<?php endif; ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <?php echo e(Form::number('order_number', null, ['class' => 'form-control', 'placeholder'=>__('Enter Order Number')])); ?>
                            ...
                            <div class="form-group" id="estatus-box">
                                <?php echo e(Form::label('estatus_id', __('Estatus'), ['class' => 'form-label'])); ?>

                                <?php echo e(Form::select('estatus_id', $estatus, $bill->status, ['class' => 'form-control select', 'id' => 'estatus', 'data-url' => route('bill.estatus_bills'), 'required' => 'required'])); ?>
        ...
        <div class="col-12">
            ...
            <div class="card repeater" data-value='<?php echo e(json_encode($bill->items)); ?>'>
                                ...
                                <tr>
                                    ...
                                    <td width="25%">
                                        <div class="form-group flex-nowrap">
                                            <?php echo e(Form::select('items', $product_services, null, ['class' => 'form-control select item select2', 'data-url' => route('bill.product')])); ?>

                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group price-input input-group search-form flex-nowrap">
                                            <?php echo e(Form::number('quantity', null, ['class' => 'form-control quantity', 'required' => 'required', 'placeholder' => __('Qty'), 'required' => 'required'])); ?>
                                    ...
                                    <td>
                                        <div class="form-group price-input input-group search-form flex-nowrap">
                                            <?php echo e(Form::number('price', null, ['class' => 'form-control price', 'required' => 'required', 'placeholder' => __('Price'), 'required' => 'required'])); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="form-group">
                                        <div class="input-group ">
                                            <?php echo e(Form::number('amount',null, array('class' => 'form-control accountAmount','placeholder'=>__('Amount')))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\willt\Desktop\Workspace Bladimir\codecanyon-aIPVP9oe-accountgo-accounting-and-billing-tool\main-file\resources\views/bill/edit.blade.php ENDPATH**/ ?>