...
<?php $__env->startSection('action-btn'); ?>
    <div class="d-flex">
        ...
        <a href="<?php echo e(route('accountstatement.export')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Export')); ?>" class="btn btn-sm btn-primary me-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        ...
                                        <?php echo e(Form::label('type', __('Type'), ['class' => 'text-type'])); ?>
                                            ...
                                            <?php echo e(Form::select('type',$types,isset($_GET['type'])?$_GET['type']:'', array('class' => 'form-control','placeholder' => __('Select Category')))); ?>
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto d-flex mt-4">
                                        ...
                                        <a href="#" class="btn btn-sm btn-primary me-2" onclick="document.getElementById('report_account').submit(); return false;" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>" data-original-title="<?php echo e(__('apply')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\willt\Desktop\Workspace Bladimir\codecanyon-aIPVP9oe-accountgo-accounting-and-billing-tool\main-file\resources\views/report/statement_report.blade.php ENDPATH**/ ?>