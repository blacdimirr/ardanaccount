                        ...
                        <td>
                            <table class="no-space">
                                <tbody>
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($settings_data['proposal_qr_display']) && $settings_data['proposal_qr_display'] == 'on'): ?>
                                        <tr>
                                            <td colspan="2">
                ...
                <tbody>
                    <tr>
                        ...
                        <?php if($settings['shipping_display'] == 'on'): ?>
                            <td class="text-right">
                                <strong style="margin-bottom: 10px; display:block;"><?php echo e(__('Ship To to')); ?>:</strong>
                                <p>
...
<?php /**PATH C:\Users\willt\Desktop\Workspace Bladimir\codecanyon-aIPVP9oe-accountgo-accounting-and-billing-tool\main-file\resources\views/proposal/templates/template1.blade.php ENDPATH**/ ?>