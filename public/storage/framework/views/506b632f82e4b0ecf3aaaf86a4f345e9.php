                    ...
                    <div class="card-body">
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto d-flex mt-4">
                                ...
                                <a href="#" class="btn btn-sm btn-primary me-2" onclick="document.getElementById('transfer_form').submit(); return false;" data-bs-toggle="tooltip"  title="Apply" data-original-title="<?php echo e(__('apply')); ?>">
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit transfer')): ?>
                                                    <div class="action-btn me-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center bg-info" data-url="<?php echo e(route('transfer.edit',$transfer->id)); ?>" data-ajax-popup="true" title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Transfer')); ?>" data-bs-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/resources/views/transfer/index.blade.php ENDPATH**/ ?>