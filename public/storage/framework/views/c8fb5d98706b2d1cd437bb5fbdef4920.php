                                                                            ...
                                                                            <tr>
                                                                                <td style="width:110px;">
                                                                                    ...
                                                                                    <img alt="" height="auto"
                                                                                        ...
                                                                                        alt="<?php echo e(config('app.name', 'AccountGo')); ?>"
                                                                                        class="logo logo-lg"
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700"><?php echo e(__('Subject : ') . 'Testing purpose mail send'); ?></b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;">
                                                                            <?php echo e(__('This mail send only for testing purpose.')); ?>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal"><?php echo e(__('Feel free to reach out if you have any questions.')); ?></i>
                                                                        </p>
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal"><?php echo e(__('Thank you for your business!')); ?></i>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal"><b
                                                                                    style="font-weight:700"><?php echo e(isset(App\Models\Utility::settings()['company_name']) && !empty(App\Models\Utility::settings()['company_name']) ? App\Models\Utility::settings()['company_name'] : env('APP_NAME')); ?></b></i>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
...
<?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/resources/views/email/test_mail.blade.php ENDPATH**/ ?>