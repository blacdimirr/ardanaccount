                                    ...
                                    <div class="form-group mb-0">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="is_feature_cards_on"
                                                id="is_feature_cards_on"  <?php echo e(isset($settings['is_feature_cards_on']) && $settings['is_feature_cards_on'] == 'on' ? 'checked="checked"' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('feature_create')); ?>" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" title="<?php echo e(__('Create Features')); ?>"
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <h5 class="mb-2"><?php echo e(__('Feature Section Head')); ?></h5>
                                </div>
                                <div class="col switch-width text-end">
                                    <div class="form-group mb-0">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="is_feature_section_on"
                                                id="is_feature_section_on"  <?php echo e(isset($settings['is_feature_section_on']) && $settings['is_feature_section_on'] == 'on' ? 'checked="checked"' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-lg-9 col-md-9 col-sm-9">
                                    <h5><?php echo e(__('Features Block List')); ?></h5>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('features_create')); ?>" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" title="<?php echo e(__('Create Features Block')); ?>"
                                        class="btn btn-sm btn-primary">
                                        <i class="ti ti-plus text-light"></i>
                                    </a>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/ardan.com.do/account.ardan.com.do/Modules/LandingPage/Resources/views/landingpage/features/index.blade.php ENDPATH**/ ?>